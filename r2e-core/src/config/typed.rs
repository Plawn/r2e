...
pub struct PropertyMeta {
    ...
    pub is_section: bool,
    /// Presence oracle for this property, generated by
...
impl PropertyMeta {
    ...
    /// Baseline probe: the property resolves iff its `full_key` is present in
    /// the config map. The derive substitutes a wider probe for properties
    /// with extra sources (e.g. `#[config(env = "...")]`); manual
    /// [`ConfigProperties`] impls that build `PropertyMeta` by hand can use
    /// this directly.
    pub fn in_config_map(config: &R2eConfig, meta: &PropertyMeta) -> bool {
