...
// One module per proto package plus `FILE_DESCRIPTOR_SET` (combined encoded
// descriptor set, consumed by gRPC server reflection) — all generated by the
// one-line `build.rs` (`r2e_grpc_build::compile()`).
pub mod proto {
