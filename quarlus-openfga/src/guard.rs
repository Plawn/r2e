    ...
    fn check(
        ...
        async move {
            let user = user.ok_or_else(|| {
                (
                    quarlus_core::http::StatusCode::UNAUTHORIZED,
                    quarlus_core::http::Json(serde_json::json!({
            ...
            let object = object_result.map_err(|e| {
                ...
                (
                    quarlus_core::http::StatusCode::BAD_REQUEST,
                    quarlus_core::http::Json(serde_json::json!({
            ...
            match registry.check(&user, relation, &object).await {
                ...
                Ok(false) => {
                    ...
                    Err((
                        quarlus_core::http::StatusCode::FORBIDDEN,
                        quarlus_core::http::Json(serde_json::json!({
                            "error": "Access denied"
                        })),
                    )
                ...
                Err(e) => {
                    ...
                    Err((
                        quarlus_core::http::StatusCode::INTERNAL_SERVER_ERROR,
                        quarlus_core::http::Json(serde_json::json!({
...
mod tests {
    use super::*;
    use quarlus_core::guards::PathParams;
    use quarlus_core::http::{HeaderMap, Uri};
