//! OpenFGA fine-grained authorization for Quarlus.
//!
//! This crate provides Zanzibar-style relationship-based access control (ReBAC)
//! for Quarlus applications using [OpenFGA](https://openfga.dev/).
//!
//! # Overview
//!
...
//!
//! ```ignore
//! use quarlus_openfga::{OpenFgaConfig, OpenFgaRegistry};
//!
...
//!
//! ```ignore
//! use quarlus_openfga::OpenFgaRegistry;
//!
